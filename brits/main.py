...
def main():
    ...
    args.train_size, args.dim = train_dataloader.dataset.X.shape
    args.val_size, args.val_dim = val_dataloader.dataset.X.shape
    args.test_size, args.test_dim = test_dataloader.dataset.X.shape
    ...
    if not args.test:
        ...
        try:
            ...
            for epoch in iterator:
                loss = engine.train(data_loader, epoch)
